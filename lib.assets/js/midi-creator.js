class MidiCreator {
  constructor(conf) {
    ...
    this.instrumentCode = conf.instrumentCode || 0;
    ...
    this.beats = conf.beats || 4;
    this.beatType = conf.beatType || 4;
    this.interchangable = conf.interchangable || 8;
    ...
    this.createMidi = function (raw) {
      ...
      //trk0.smfSeqName('Little Lame').smfBPM(90);
      let track1 = new JZZ.MIDI.SMF.MTrk();

    

      track1.add(0, JZZ.MIDI.smfTimeSignature(getBeats(), getBeatType(), getInterchangable()));
      track1.add(0, JZZ.MIDI.smfBPM(this.tempo));      
      track1.add(0, JZZ.MIDI.smfSeqName('Judul'));      
      track1.add(0, JZZ.MIDI.program(this.channel, this.instrumentCode));     
